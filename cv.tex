...
%% If you need to pass whatever options to color
\PassOptionsToPackage{dvipsnames}{xcolor}

%% If you are using \orcid or academics
%% icons, make sure you have the academic
...
%% Fork (before v1.6.5a): CV dark mode toggle enabler to use an inverted color palette.
%% Use the "dark mode" option if you want a color palette used to 
% \documentclass[10pt,a4paper,ragged2e,with hyper,darkmode]{altacv}

\documentclass[10pt,a4paper,ragged2e,withhyper]{altacv}

%% AltaCV uses the fontawesome5 and academicians fonts
%% and packages.
%% See http://texdoc.net/pkg/fontawesome5 and http://texdoc.net/pkg/academicons for a full list of symbols. You MUST compile with XeLaTeX or LuaLaTeX if you want to use academics.

% Change the page layout if you need to
\geometry{left=1.2cm,right=1.2cm,top=1cm,bottom=1cm,columnsep=0.75cm}

% The parasol package lets you typeset columns of text in parallel
\usepackage{paracol}
...
% Change the bullets for itemizing and rating marker
...
\personalinfo{
    ...
    %\medium{nicolasomar}
    %% You MUST add the academician option to \documentclass, then compile with LuaLaTeX or XeLaTeX, if you want to use \orcid or other academic commands.
